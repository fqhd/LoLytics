                    ...
                    <div className="data">
                        <div className="top-row">
                            ...
                            <div className='minimap'>
                                <img src='images/nexus.png' class="blue-building building" style={{
                                    left: '20px',
                                    bottom: '20px',
                                    width: '32px',
                                }} />

                                <img src='images/nexus.png' class="red-building building" style={{
                                    top: '20px',
                                    right: '20px',
                                    width: '32px',
                                }} />

                                {frames && frames[frameIndex].teams[0].inhibs[1] == 0 && <img src='images/inhibitor.png' class="blue-building building" style={{
                                    bottom: '50px',
                                    left: '50px',
                                    width: '24px',
                                }}/>}
