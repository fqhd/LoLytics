                    ...
                    <div className="champion-row" key={index}>
                        {champion.deathTimer > 0 ? (
                            <div
                                ...
                                style={{
                                    backgroundImage: `url(/images/icons/${champion.champion}.jpg)`,
                                }}
                            >
                                <span className="death-timer">
                                    {Math.ceil(champion.deathTimer)}
                                </span>
                            </div>
                        ) : (
                            <div
                        ...
                        <span className="champion-cs">
                            {champion.creepscore} CS
                        </span>
