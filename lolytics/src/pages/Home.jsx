...
export default function Home() {
    ...
    return (
        <div className="container">
            <div className={`username ${searched ? 'username-show' : ''}`}>
                {name.toUpperCase()}#{tag.replaceAll('#', '').toUpperCase()}
            </div>

            <div
                className={`input-group-wrapper ${searched ? 'fade-out' : ''}`}
            >
                <div className="title">LoLytics</div>
                <div
                    className={`error-message ${error != '' ? 'error-message-show' : ''}`}
                >
                    {error}
                </div>
            ...
            <div
                className={`match-history-container ${showMatches && selectedMatch === null ? 'show' : ''}`}
            >
            ...
            {selectedMatch !== null && (
                <div
                    className={`match-details ${showMatchDetails ? 'show' : ''}`}
                    style={{
                    ...
                    <div className="data">
                        <div className="top-row">
                            ...
                            <div className="minimap">
                                <img
                                    ...
                                    className="blue-building building"
                                    style={{
                                        left: '6%',
                                        bottom: '6%',
                                        width: '9.6%',
                                ...
                                <img
                                    src="images/nexus.png"
                                    className="red-building building"
                                    style={{
                                        top: '6%',
                                        right: '6%',
                                        width: '9.6%',
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].inhibs[1] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="blue-building building"
                                            style={{
                                                bottom: '15%',
                                                left: '15%',
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].inhibs[0] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].inhibs[2] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].inhibs[1] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].inhibs[0] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].inhibs[2] ==
                                        0 && (
                                        <img
                                            src="images/inhibitor.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[0] ==
                                        1 && (
                                        <img
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[1] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[2] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[3] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[4] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[5] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[6] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[7] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].towers[8] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="blue-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[0] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[1] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[2] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[3] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[4] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[5] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[6] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[7] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[1].towers[8] ==
                                        1 && (
                                        <img
                                            src="images/tower.png"
                                            className="red-building building"
                                ...
                                {frames &&
                                    frames[frameIndex].teams[0].players.map(
                                        (champ, i) => {
                                            const mapWidth = 15000;
                                            const mapHeight = 15000;
                                            const xPercent =
                                                (champ.x / mapWidth) * 100;
                                            const yPercent =
                                                (1 - champ.y / mapHeight) * 100;
                                            const deathTimer = Math.ceil(
                                                champ.deathTimer,
                                            );
                                ...
                                {frames &&
                                    frames[frameIndex] &&
                                    frames[frameIndex].teams[1].players.map(
                                        (champ, i) => {
                                            const mapWidth = 15000;
                                            const mapHeight = 15000;
                                            const xPercent =
                        ...
                        <div className="bottom-row">
                            ...
                            {frames && frames[frameIndex] && (
                                <Scoreboard data={frames[frameIndex]} />
                            )}
                            {runes && (
                                <Runes
                                    data={runes}
                                    events={events[frameIndex]}
                                />
                            )}
                        </div>
                    </div>
